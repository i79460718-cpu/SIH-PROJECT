...
import { checkSpam } from "../services/spamDetection.ts";
import { findDuplicateMatches } from "../services/duplicateDetection.ts";
import { routeIssue } from "../services/departmentRouting.ts";
...
class IssueRepository {
  ...
  async analyseReport(input: {
    ...
    return {
      ...
      normalizedIntent: routing.normalizedIntent,
      severity: routing.severity,
