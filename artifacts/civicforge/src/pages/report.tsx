    ...
    <div className="mx-auto max-w-[960px] px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-[hsl(var(--muted-foreground))] max-w-2xl">
          Describe the problem in English, Hindi, or Hinglish. Our AI instantly screens for duplicates, calculates public safety priority, and routes to the exact department in Jharkhand.
        </p>
      </div>
      ...
      <div className="mb-6 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4 shadow-sm">
        <p className="mono-font text-[10px] uppercase font-bold text-[hsl(var(--muted-foreground))] mb-2 flex items-center gap-1.5">
          ...
          Click to load demo scenarios for judges:
        </p>
        ...
        <form onSubmit={handleAnalyse} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. There is a deep pothole outside DAV School Bariatu causing accidents, or drinking water supply pipe is broken..."
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-4">
              ...
              {photoUrl ? (
                ...
                <span className="text-xs text-[hsl(var(--muted-foreground))]">
                  Photos increase priority scoring by confirming physical damage.
                </span>
              )}
            </div>
          </div>
            ...
            >
              {isAnalysing ? (
                <>
                  ...
                  Running AI Grievance Intelligence Pipeline...
                </>
              ) : (
                <>
                  <Sparkles size={18} />
                  Analyse & Submit Grievance
                </>
              )}
            </button>
          </div>
