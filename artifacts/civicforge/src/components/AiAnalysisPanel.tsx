    ...
    <div className="rounded-2xl border border-[hsl(var(--primary)/.35)] bg-gradient-to-br from-[hsl(var(--card))] to-[hsl(var(--muted)/.3)] p-5 md:p-6 shadow-[4px_4px_0_hsl(var(--foreground)/.08)]">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-bold tracking-tight text-[hsl(var(--foreground))]">AI Grievance Intelligence</h4>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-3">
          <p className="mono-font text-[10px] uppercase text-[hsl(var(--muted-foreground))]">Spam Risk</p>
          <div className="mt-1 flex items-baseline gap-1.5">
            <span className="text-base font-bold text-[hsl(var(--foreground))]">{String(analysis.spamScore).padStart(2, "0")}%</span>
            <span className="text-[10px] text-emerald-600 font-semibold">Safe ✓</span>
          </div>
        </div>

        <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-3">
          <p className="mono-font text-[10px] uppercase text-[hsl(var(--muted-foreground))]">Detected Category</p>
          <div className="mt-1 flex items-baseline gap-1.5">
        ...
        <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-3">
          <p className="mono-font text-[10px] uppercase text-[hsl(var(--muted-foreground))]">Severity Level</p>
          <div className="mt-1 flex items-baseline gap-1.5">
            <span className="text-xs font-bold text-[hsl(var(--foreground))]">{analysis.severity}</span>
          </div>
          <p className="mt-0.5 text-[10px] text-[hsl(var(--primary))] font-semibold">Triaged Priority</p>
        </div>
      ...
      {!compact && breakdown && (
        <div className="mt-5 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-[hsl(var(--foreground))]">Explainable Priority Engine</span>
            <span className="mono-font text-xs font-bold text-[hsl(var(--primary))]">
              {analysis.priorityScore} / 100 ({analysis.priority})
            </span>
          </div>
          <p className="mt-1 text-[11px] text-[hsl(var(--muted-foreground))]">
            Calculated algorithmically from multi-factor risk, location sensitivity, and citizen consensus:
          </p>

          <div className="mt-3 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-[hsl(var(--muted-foreground))]">Issue Severity Weight</span>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-[hsl(var(--muted-foreground))]">Citizen Reports Volume</span>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-[hsl(var(--muted-foreground))]">Sensitive Location (School / Hospital / Transit)</span>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-[hsl(var(--muted-foreground))]">Time Elapsed Unresolved</span>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-[hsl(var(--muted-foreground))]">Repeat Citizen Citations</span>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="mono-font text-[10px] uppercase font-bold text-indigo-700 dark:text-indigo-300">
              AI Automated Department Routing
            </p>
