...
export function TrackComplaintDialog({ open, onClose }: TrackComplaintDialogProps) {
  ...
  return createPortal(
    // The map has local controls at z-[1000]; keep the modal in the document layer above them.
    <div className="fixed inset-0 z-[1100] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 shadow-2xl">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-base font-bold text-[hsl(var(--foreground))]">{t("track.civicTitle")}</h3>
        ...
        >
          <div className="relative flex items-center">
            ...
            >
              {t("track.trackBtn")} <ArrowRight size={13} className="inline" />
            </button>
          </div>
